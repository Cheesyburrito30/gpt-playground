...
const db = new sqlite3_1.default.Database("./server/presets.db", (err) => {
    if (err) {
...
app.post("/presets", (req, res) => {
    const { name, model, temperature, max_tokens, top_p, presence_penalty, frequency_penalty, n, systemMessage, } = req.body;
